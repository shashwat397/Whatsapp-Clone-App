          ...
          <div className="siderbar__wrapper">
            ...
            <div className="sidebar__header">
              ...
              <p className="sidebar__greeting mobile__tag">
                {" "}
                <a
                  href="https://github.com/shashwat397"
                  style={{ color: "white" }}
                >
                  | MADE BY <span style={{ color: "white" }}>SHASHWAT</span> |
                </a>
              </p>
        ...
        <div className={"sidebar"}>
          <div className="sidebar__header">
            ...
            <p className="sidebar__greeting">
              {" "}
              <a href="https://github.com/shashwat397">
                | MADE BY <span style={{ color: "blue" }}>SHASHWAT</span> |
              </a>
            </p>
            <div className="sidebar__headerRight">
              <IconButton>
